                    ...
                    {cssArt.map((art) => (
                        <div key={art.id}>
                            <div className="aspect-square rounded-xl overflow-hidden relative group active:scale-95 active:opacity-75 transition-all duration-300 border border-purple-500/20 hover:border-purple-500">
                                ...
                                />
                                <Link href={art.url} target="_blank" rel="noopener noreferrer" className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent via-[rgba(0,0,0,0.5)] to-[rgba(0,0,0)] grid justify-center items-end group-hover:translate-y-2 transition-all duration-300 cursor-pointer translate-y-full">
